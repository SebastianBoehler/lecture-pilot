...
- **Exact teaching evidence and scoped repairs** _(From feedback)_ — Practice-design proposals select exact source excerpts by ID. Approved checkpoints are assembled by the backend, while section and block repair contracts keep their scope. Supporting evidence reaches the writer and reviewer without exposing hidden assessment questions; professor review remains required.
- **Less friction during course creation** _(From feedback)_ — Optional media review no longer blocks generation. Source proposals and refresh errors show accurate states, navigation labels stay readable, and browser error responses retain repair and retry information. Reading drafts does not consume the generation rate allowance.
...
- **Exakte Lehrbelege und gezielte Reparaturen** _(Aus Feedback)_ — Übungskonzepte wählen exakte Quellenauszüge per ID. Freigegebene Checkpoints werden im Backend zusammengesetzt; Reparaturverträge begrenzen Abschnitte und Blöcke. Ergänzende Belege erreichen Erstellung und Prüfung ohne verborgene Prüfungsfragen; die Freigabe durch Lehrende bleibt erforderlich.
- **Weniger Reibung bei der Kurserstellung** _(Aus Feedback)_ — Die optionale Medienprüfung blockiert die Generierung nicht mehr. Quellenvorschläge und Aktualisierungsfehler zeigen korrekte Zustände, Navigationsbeschriftungen bleiben lesbar und Browserfehler enthalten Reparatur- und Wiederholungshinweise. Das Lesen von Entwürfen verbraucht kein Generierungslimit.
...
LecturePilot now generates course canvases faster and in the selected language, gives students evaluated exam-readiness feedback, and makes learner and lecturer workflows clearer and safer.
...
**Schnellere Kurserstellung und stärkeres Lernfeedback**

LecturePilot erstellt Kurs-Canvases jetzt schneller und in der gewählten Sprache, gibt Studierenden bewertetes Feedback zur Prüfungsreife und macht Abläufe für Lernende und Lehrende klarer und sicherer.
