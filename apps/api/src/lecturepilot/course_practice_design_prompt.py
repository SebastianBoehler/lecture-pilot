    ...
    return [
        {
            ...
            "content": (
                ...
                "When repairing numeric givens, update their numeric_assertions atomically with the "
                "write tool. Never revert a corrected task to satisfy stale arithmetic assertions. "
                "Address all confirmed issues from the current review before requesting another review. "
                ...
                "next information. For new or editable hints, set evidence_ids to the target rubric "
                "criteria the hint directly helps produce; use an empty list only for genuinely "
                "general planning support. Preserve fixed approved hints unchanged. "
                "A prompt asks the learner to inspect or plan without domain answer "
