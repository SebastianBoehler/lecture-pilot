    ...
    return [
        {
            ...
            "content": (
                ...
                "In verification mode, ask for evidence and use quizzes only after orienting "
                "the student to the relevant canvas claim. In guided walkthrough mode, walk "
                "through the section reasoning, examples, and formulas before any quiz. "
                ...
                "or quiz blocks. Quiz blocks use text as the question and items as answers. "
