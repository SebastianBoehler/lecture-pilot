...
export const documentOutlineItems: OutlineItem[] = [
  ...
  { id: "artifact-diagram", title: "Feature map diagram", kind: "artifact" },
  { id: "artifact-video", title: "Professor-selected video", kind: "artifact" },
  { id: "kernel-trick", title: "Kernel trick", kind: "section" },
  { id: "artifact-code", title: "Runnable code cell", kind: "artifact" },
  { id: "skill-check", title: "Skill check", kind: "check" },
  { id: "artifact-quiz", title: "Micro quiz", kind: "check" },
  { id: "artifact-playground", title: "Kernel playground", kind: "artifact" },
  { id: "failure-mode", title: "Common failure mode", kind: "section" },
  { id: "artifact-summary", title: "Generated summary", kind: "artifact" },
];
