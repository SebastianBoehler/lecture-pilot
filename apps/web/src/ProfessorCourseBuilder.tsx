    ...
    <main className="professor-screen">
      <section className="professor-page-header">
        ...
        <div className="professor-header-actions">
          ...
          >
            {builder.isRestoring ? "Refreshing..." : "Refresh workspace state"}
          </button>
        </div>
      </section>
      ...
      <div className="professor-flow">
        ...
        {builder.activeStep === "generate" ? <ProfessorCanvasDraftStep {...builder.generateStep} /> : null}
        {builder.activeStep === "publish" ? <ProfessorPublishStep {...builder.publishStep} /> : null}
      </div>
